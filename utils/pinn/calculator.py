...
from aromtool.utils.pinn.behler_map import SymmetryFunctionTransformer
from aromtool.utils.pinn.precision import precision_scope
...
class PINN(Calculator):
    ...
    def transformer(self) -> DescriptorTransformer:
        """
        Return the `DescriptorTransformer` of this pinn.
        """
    ...
    def get_magnetic_moment(self, atoms=None):
        """
        This pinn cannot predict magnetic moments.
        """
        return None
